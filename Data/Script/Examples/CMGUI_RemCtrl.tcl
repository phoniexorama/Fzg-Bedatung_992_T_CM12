...
#Set File format
#DStore.Format = erg
#IFileModify Data/Config/OutputQuantities DStore.Format erg
#IFileFlush

# If a TestSeries to simulate was specified
if $env(SIM_TS) {
	...
	# Start simulation of the TestSeries
	TestMgr start
	...
	# Generate the report for simulated TestSeries
